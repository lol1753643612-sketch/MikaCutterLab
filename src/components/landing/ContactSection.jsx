        ...
        {submitted ? (
          ...
          >
            ...
            <button
              type='submit'
              disabled={loading}
              className='group relative w-full sm:w-auto inline-flex items-center justify-center gap-3 px-10 py-4 rounded-xl bg-white text-black font-bold text-lg tracking-wide transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100 overflow-hidden'
            >
              ...
              {/* Glow Ring */}
              <span className="absolute inset-0 rounded-xl ring-2 ring-white/0 group-hover:ring-white/50 transition-all duration-300"></span>
            </button>
          </form>
        )}
      </div>
